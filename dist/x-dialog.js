...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _DialogPortal = __webpack_require__(13);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reactDraggable = __webpack_require__(14);
	  ...
	  _createClass(Dialog, [{
	    ...
	    value: function show(newProps) {
	      ...
	      this.setState({ isShow: true }, function () {
	        var st = setTimeout(function () {
	          ...
	          _this3.setState({
	            defaultPosition: {
	              x: parseInt((document.documentElement.clientWidth - _this3.refs.dialogContent.offsetWidth) / 2),
	              y: parseInt((document.documentElement.clientHeight - _this3.refs.dialogContent.offsetHeight) / 2)
	            }
	          }, function () {
	            ...
	            _this3.setState({
	              bounds: {
	                ...
	                right: _this3.refs.dialogContent.offsetLeft,
	                bottom: _this3.refs.dialogContent.offsetTop
	              }
	            });
	          });
	          // console.log(-this.refs.dialogContent.offsetLeft,-this.refs.dialogContent.offsetTop)
	    ...
	    value: function renderHTML() {
	      ...
	      if (typeof buttons === "undefined") {
	        this.buttons = _react2.default.createElement("div", null, _react2.default.createElement("button", { className: "d-ok", onClick: okCallback.bind(this) }, local.submit), _react2.default.createElement("button", { className: "d-cancel", onClick: this.hide.bind(this) }, local.cancel));
	      } else if (buttons) {
	      ...
	      if (this.state.isShow) {
	        var DD = this.props.draggable ? _react2.default.createElement(_reactDraggable2.default, _defineProperty({ handle: this.props.dragHandle || ".dialog-title", bounds: "parent" }, "bounds", this.state.bounds), this.renderDialog()) : this.renderDialog();
	        if (this.props.mask) {
	          return _react2.default.createElement("div", {
	            className: this.props.mask ? "x-dialog-continer x-dialog-mask" : "x-dialog-continer",
	            style: { zIndex: this.props.zIndex }
	          }, _react2.default.createElement("div", { className: "x-dialog", ref: "dialog" }, DD));
	        } else {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
		 true ? module.exports = factory(__webpack_require__(12), __webpack_require__(2)) :
