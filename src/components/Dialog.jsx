...
export default class Dialog extends Component {
  static show(config) {
    ...
    function render(props) {
      ReactDOM.render(<Dialog {...props} />, document.createDocumentFragment('div'))
    }
  ...
  renderContent = (local) => {
    ...
    if (this.props.draggable) {
      return (
        <DialogPortal {...this.props} {...this.state} local={local} />
      )
    } else {
      return <DialogPortal {...this.props} {...this.state} local={local} />
    }
  }
  //组件销毁时触发,移除绑定
